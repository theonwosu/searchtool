 ...
 * 
 */
public class ExactNameCaseInsensitiveMatcher implements SearchMatcher {
  private static ExactNameCaseInsensitiveMatcher matcher = null;
  private ExactNameCaseInsensitiveMatcher(){
  }
  ...
  public boolean match(String sourceString, String stringToMatch) {
    ...
    if(stringToMatch.equalsIgnoreCase(sourceString)){
      return true;
    }    
    return false;
  }
  
  public static synchronized ExactNameCaseInsensitiveMatcher getInstance(){
    if(matcher == null){
      matcher = new ExactNameCaseInsensitiveMatcher();
    }
    return matcher;
  }  
}
